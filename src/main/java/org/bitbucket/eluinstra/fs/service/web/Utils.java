...
public class Utils
{
	public static String getResourceString(@NonNull final Class<?> clazz, @NonNull final String propertyName)
	{
	...
	public static String getContentType(@NonNull final String pathInfo)
	{
	...
	public static String getFileExtension(@NonNull final String contentType)
	{
	...
	public static String getErrorList(@NonNull final String content)
	{
