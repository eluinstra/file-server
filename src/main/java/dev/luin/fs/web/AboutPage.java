...
public class AboutPage extends BasePage
{
	...
	public AboutPage(final PageParameters parameters) throws FileNotFoundException, IOException
	{
		...
		add(new WebMarkupContainer("fs-service.version")
				.add(new Label("version",Utils.readVersion("/META-INF/maven/dev/luin/fs/fs-service/pom.properties"))));
		add(new WebMarkupContainer("fs-core.version")
				.add(new Label("version",Utils.readVersion("/META-INF/maven/dev/luin/fs/core/fs-core/pom.properties"))));
