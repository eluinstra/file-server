...
import dev.luin.fs.web.menu.MenuItem;
import dev.luin.fs.web.menu.MenuLinkItem;
...
public class WicketApplication extends WebApplication
{
	...
	public WicketApplication(@NonNull Integer maxItemsPerPage)
	{
		...
		new MenuLinkItem(configuration,"1","serviceProperties",dev.luin.fs.web.configuration.PropertiesPage.class);
		...
		val about = new MenuLinkItem("6","about",dev.luin.fs.web.AboutPage.class);
		menuItems.add(about);
	}
